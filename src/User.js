class User {
  ...
  findAllActivityOnWeek(activityData) {
    let weeklyMinutes = this.trackOfDataOverWeek(activityData, 'minutesActive');
    ...
    let allData = []
    allData.push(weeklyMinutes, weeklySteps, weeklyFlight);
    return allData;
  }
}
